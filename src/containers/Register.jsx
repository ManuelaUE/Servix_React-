...
function Register() {
  ...
  const handleSubmit = (e) => {
        ...
        axios.post('http://127.0.0.1:5000/solicitante', {
            correo: email,
            contrasena: password,
            nombre: name,
            apellido: lastname,
                ...
                <div className="bg-white">
                    <div className="card-body p-5 text-center">
                        ...
                        <div className="mb-md-5 mt-md-4 pb-5">
                            ...
                            <h2 className="fw-bold mb-2 text-uppercase mt-3">Registro</h2>
                            ...
                            <button className="btn btn-outline-primary btn-lg px-5 mt-2" onClick={handleSubmit} type="submit">Registrar</button>
